...
class Q5TestFixture : public testing::Test {
public:
    Q5TestFixture()
...
TEST_F(Q5TestFixture, testQ5duplicate) {
    ...
    auto input = Scan(name)
            ...
            .Discretize(Dimension::Theta, rational_times_real({2, 400}, PI))
            .Discretize(Dimension::Phi, rational_times_real({1, 400}, PI));
