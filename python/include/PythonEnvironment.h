...
// class LocalEnvironment: lightdb::execution::Environment {
//     public:
//         explicit LocalEnvironment(bool include_gpus=true)
//                 : lightdb::execution::Environment::Environment(include_gpus ? GetLocalGPUs() : lightdb::execution::std::vector<GPU>{})
//         { }

//     private:
//         static lightdb::execution::std::vector<GPU> GetLocalGPUs() {
//             lightdb::execution::std::vector<GPU> gpus;
//             size_t count = GPUContext::device_count();
