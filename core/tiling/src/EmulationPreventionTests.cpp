...
class EmulationPreventionTestFixture : public testing::Test {
    ...
    EmulationPreventionTestFixture() = default;
...
TEST_F(EmulationPreventionTestFixture, testEmulation) {
    ...
    bytestring three = EmulationPreventionTestFixture::three();
    bytestring threeone = EmulationPreventionTestFixture::threeone();
    bytestring twoone = EmulationPreventionTestFixture::twoone();
    bytestring oneone = EmulationPreventionTestFixture::oneone();
    bytestring zeroone = EmulationPreventionTestFixture::zeroone();
    bytestring random = EmulationPreventionTestFixture::random();
    bytestring other = EmulationPreventionTestFixture::other();
