# height: 3840, width: 1920
# rows: 4, columns: 4
#tile width: 480, tile height: 960
ffmpeg \
  -i /home/bhaynes/projects/visualcloud/test/resources//test-4K-40s.h264 \
  -vcodec h264_cuvid \
  -filter_complex "
    [0:v]crop=480:960:0:0[tile0];
    [0:v]crop=480:960:480:0[tile1];
    [0:v]crop=480:960:960:0[tile2];
    [0:v]crop=480:960:1440:0[tile3];
    [0:v]crop=480:960:0:960[tile4];
    [0:v]crop=480:960:480:960[tile5];
    [0:v]crop=480:960:960:960[tile6];
    [0:v]crop=480:960:1440:960[tile7];
    [0:v]crop=480:960:0:1920[tile8];
    [0:v]crop=480:960:480:1920[tile9];
    [0:v]crop=480:960:960:1920[tile10];
    [0:v]crop=480:960:1440:1920[tile11];
    [0:v]crop=480:960:0:2880[tile12];
    [0:v]crop=480:960:480:2880[tile13];
    [0:v]crop=480:960:960:2880[tile14];
    [0:v]crop=480:960:1440:2880[tile15]" \
  -map "[tile0]" \
    -vcodec h264_nvenc \
    -b:v 1000k \
    -minrate 1000k \
