...
# rows: 4, columns: 4
#tile width: 128, tile height: 256
ffmpeg \
  -i /home/bhaynes/projects/visualcloud/test/resources//test-1K-40s.h264 \
  -vcodec h264_cuvid \
  -filter_complex "
    [0:v]crop=128:256:0:0[tile0];
    [0:v]crop=128:256:128:0[tile1];
    [0:v]crop=128:256:256:0[tile2];
    [0:v]crop=128:256:384:0[tile3];
    [0:v]crop=128:256:0:256[tile4];
    [0:v]crop=128:256:128:256[tile5];
    [0:v]crop=128:256:256:256[tile6];
    [0:v]crop=128:256:384:256[tile7];
    [0:v]crop=128:256:0:512[tile8];
    [0:v]crop=128:256:128:512[tile9];
    [0:v]crop=128:256:256:512[tile10];
    [0:v]crop=128:256:384:512[tile11];
    [0:v]crop=128:256:0:768[tile12];
    [0:v]crop=128:256:128:768[tile13];
    [0:v]crop=128:256:256:768[tile14];
    [0:v]crop=128:256:384:768[tile15]" \
  -map "[tile0]" \
    -vcodec h264_nvenc \
    -b:v 1000k \
    -minrate 1000k \
